...
checkneuerlaptop, checkneueshandy, checkneuestelefon, checkwinuser, checksapuser, checkdrucker, bemerkungenit, alleserledigt, eintrittstatus) 
...
INSERT INTO usereintritt(vorname, mittelname, nachname, jobtitel, eintrittdatum, neuerlaptop, neueshandy, neuestelefon, winuser, sapuser, bemerkungenhr, 
checkneuerlaptop, checkneueshandy, checkneuestelefon, checkwinuser, checksapuser, checkdrucker, bemerkungenit, alleserledigt, eintrittstatus) 
VALUES ('Leonard', NULL , 'Geiger', 'Lehrer', '1970.01.20', true, true, true, true, true, 'Maus und Tastatur wird von dem Vorgänger übernommen' , true, true, true, true, true, true, 'Alles nach Checkliste erledigt', false, '2');

INSERT INTO usereintritt(vorname, mittelname, nachname, jobtitel, eintrittdatum, neuerlaptop, neueshandy, neuestelefon, winuser, sapuser, bemerkungenhr, 
checkneuerlaptop, checkneueshandy, checkneuestelefon, checkwinuser, checksapuser, checkdrucker, bemerkungenit, alleserledigt, eintrittstatus) 
VALUES ('Sandro', 'Fritz', 'Cangelosi', 'IT', '2021.12.30', true, true, true, true, true, 'Bitte schnell erledigen', true, true, true, true, true, true, 'Alles korrekt erledigt', true, '3');

INSERT INTO usereintritt(vorname, mittelname, nachname, jobtitel, eintrittdatum, neuerlaptop, neueshandy, neuestelefon, winuser, sapuser, bemerkungenhr, 
checkneuerlaptop, checkneueshandy, checkneuestelefon, checkwinuser, checksapuser, checkdrucker, bemerkungenit, alleserledigt, eintrittstatus) 
VALUES ('Christoph', NULL , 'Mueller', 'IT', '1991.06.01', false, false, false, false, false, NULL , false, false, false, false, false, false, 'Bitte loeschen, Schreibfehler', false, '4');
